...
import { Moon, Mail, Lock, Eye, EyeOff, ArrowRight } from 'lucide-react';
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      <div className="orb orb-rose w-80 h-80 top-[-5%] right-[-5%]" />
      <div className="orb orb-luna w-64 h-64 bottom-[5%] left-[-5%]" />
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="mt-6 text-3xl font-display font-light text-white">Welcome back</h1>
          <p className="mt-2 text-white/50 text-sm">Sign in to continue your health journey</p>
        </div>
        ...
        <div className="card p-8">
          ...
          <button
            ...
            className="w-full btn-ghost py-3 flex items-center justify-center gap-3 mb-6 disabled:opacity-50"
          >
            {googleLoading ? (
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs text-white/30">
              <span className="bg-surface-2 px-3">or sign in with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="flex justify-end">
              <Link href="/auth/forgot-password" className="text-xs text-rose-400 hover:text-rose-300">
                Forgot password?
              </Link>
            </div>
